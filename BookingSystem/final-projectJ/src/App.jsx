...
// Sample data (matching what you might have in your original BookingSystem)
...
// Home Page Component (moved from App)
function HomePage() {
  ...
  const handleCreateResource = async (formData) => {
    ...
    // Simulate API call (in a real app, this would be fetch)
    setTimeout(() => {
      const newResource = {
